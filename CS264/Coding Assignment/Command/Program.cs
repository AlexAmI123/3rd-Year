                    ...
                    case "style":
                        if(cmdCont[1].Equals("left-eye"))
                        {
                            for(int i = 0; i < commands.Count; i++)
                            {
                                ...
                                {
                                    int ind2 = i+2;
                                    Style s1 = new Style(canvas, redoList, cmdCont[1], cmdCont[2], ind2);
                                    s1.Execute();
                                }
                            }
                        }
                        else if(cmdCont[1].Equals("right-eye"))
                        {
                            for(int i = 0; i < commands.Count; i++)
                            {
                                ...
                                {
                                    int ind2 = i+2;
                                    Style s2 = new Style(canvas, redoList, cmdCont[1], cmdCont[2], ind2);
                                    s2.Execute();
                                }
                            }
                        }
                        else if(cmdCont[1].Equals("left-brow"))
                        {
                            for(int i = 0; i < commands.Count; i++)
                            {
                                ...
                                {
                                    int ind2 = i+2;
                                    Style s3 = new Style(canvas, redoList, cmdCont[1], cmdCont[2], ind2);
                                    s3.Execute();
                                }
                            }
                        }
                        else if(cmdCont[1].Equals("right-brow"))
                        {
                            for(int i = 0; i < commands.Count; i++)
                            {
                                ...
                                {
                                    int ind2 = i+2;
                                    Style s4 = new Style(canvas, redoList, cmdCont[1], cmdCont[2], ind2);
                                    s4.Execute();
                                }
                            }
                        }
                        else if(cmdCont[1].Equals("mouth"))
                        {
                            for(int i = 0; i < commands.Count; i++)
                            {
                                ...
                                {
                                    int ind2 = i+2;
                                    Style s5 = new Style(canvas, redoList, cmdCont[1], cmdCont[2], ind2);
                                    s5.Execute();
                                }
                            }
                        }
